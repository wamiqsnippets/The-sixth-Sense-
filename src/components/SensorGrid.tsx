...
import { CloudRain, Sprout, Sun, Thermometer, Waves } from 'lucide-react';
...
export const SensorGrid: React.FC<SensorGridProps> = ({ data }) => {
  const sensors = [
    ...
    { label: 'Rain Level', value: `${data.rainLevel}%`, icon: CloudRain, color: 'text-indigo-500', bg: 'bg-indigo-50' },
    { label: 'Water Level', value: `${data.waterLevel}%`, icon: Waves, color: 'text-cyan-500', bg: 'bg-cyan-50' },
  ];
